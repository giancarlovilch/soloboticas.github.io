...
--
-- Host: localhost:3306
-- Generation Time: May 14, 2026 at 12:02 AM
...
(28, 4, 11, NULL, '2026-05-11', '2026-05-11 07:00:00', NULL, 'A TIEMPO', NULL, 'PENDIENTE'),
(29, 60, 53, NULL, '2026-05-11', '2026-05-11 14:40:00', NULL, 'TEMPRANO', NULL, 'PENDIENTE'),
(30, 29, 13, NULL, '2026-05-11', '2026-05-11 07:00:00', '2026-05-11 15:05:00', 'A TIEMPO', NULL, 'PENDIENTE'),
(31, 29, 13, NULL, '2026-05-13', '2026-05-13 07:00:00', '2026-05-13 23:00:00', 'A TIEMPO', NULL, 'PENDIENTE');
...
(116, 1655.50, 170.00, 21050.00, 0.00, 0.00, 0.00, 0.00, 9421.05, 32296.55, 32296.55, 1927.68, 1702.50, 32692.23, -395.68, 'FALTANTE', NULL, 32296.55, 0.00, 32296.55, 239),
(117, 302.90, 430.00, 140.00, 34900.00, 0.00, 0.00, 0.00, 726.72, 36499.62, 36499.62, 656.95, 0.00, 37474.13, -974.51, 'FALTANTE', NULL, 37499.62, 0.00, 37499.62, 179),
...
(569, 2, 3, 1, '2026-05-20', 4, 1, NULL, NULL),
...
--
ALTER TABLE `ajuste_esperado`
  MODIFY `id_ajuste` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `movimiento_sesion`
  MODIFY `id_movimiento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=165;
...
--
ALTER TABLE `pago_personal`
  MODIFY `id_pago_personal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `rectificacion_cuadre`
  MODIFY `id_rectificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT for table `reporte_venta`
--
ALTER TABLE `reporte_venta`
  MODIFY `id_reporte_venta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;
...
--
ALTER TABLE `sesion_caja`
  MODIFY `id_sesion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=120;

--
-- AUTO_INCREMENT for table `sesion_participante`
--
ALTER TABLE `sesion_participante`
  MODIFY `id_sesion_participante` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=228;
