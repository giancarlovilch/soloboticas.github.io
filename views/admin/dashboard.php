    ...
    <div class="contenedor contenedor-grid">
        <nav class="nav" id="sideNav">
            <ul class="list">
                ...
                <li class="list__item">
                    <a href="<?= $basePath ?>/caja/auditoria" class="list__button">
                        <img src="<?= $basePath ?>/assets/img/icons/sales.svg" class="list__img">
                        <span class="nav__link">Auditoría</span>
                    </a>
                </li>
                ...
                <li class="list__item">
                    <a href="<?= $basePath ?>/admin/ventas-emergencia" class="list__button">
                        <img src="<?= $basePath ?>/assets/img/icons/sales.svg" class="list__img">
                        <span class="nav__link">Ventas Emergencia</span>
                    </a>
                </li>
                ...
                <li class="list__item <?= $navActive['supervisores'] ? 'list__item--active' : '' ?>">
                    <a href="?page=supervisores" class="list__button">
                        <img src="<?= $basePath ?>/assets/img/icons/sales.svg" class="list__img">
                        <span class="nav__link">Supervisores</span>
                    </a>
                </li>
                ...
                <li class="list__item">
                    <a href="<?= $basePath ?>/plin" class="list__button">
                        <img src="<?= $basePath ?>/assets/img/icons/sales.svg" class="list__img">
                        <span class="nav__link">Pagos PLIN</span>
                    </a>
                </li>

                <li class="list__item">
                    <a href="<?= $basePath ?>/admin/solobank-vales" class="list__button">
                        <img src="<?= $basePath ?>/assets/img/icons/sales.svg" class="list__img">
                        <span class="nav__link">SoloBank</span>
                    </a>
                </li>
